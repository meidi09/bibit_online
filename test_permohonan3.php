...
if (empty($_GET['id_persemaian'])) {
    header("Location: test_permohonan3.php?id_persemaian=1");
    exit;
}
                ...
                <fieldset>
                    ...
                    <label>Persemaian:
                        <select id="pilih_persemaian" name="pilih_persemaian" onchange="document.location.href=this.value">
                            ...
                            ?>
                                <option value="test_permohonan3.php?id_persemaian=<?php echo $row["id_persemaian"]; ?>" <?php if ($_GET['id_persemaian'] == $row["id_persemaian"]) echo 'selected="selected"'; ?>><?php echo $row["kecamatan_persemaian"]; ?></option>
                            <?php $no++;
                            } ?>
                        </select>
                    </label>
